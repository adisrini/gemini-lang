...
(******* OPERATORS *******)
(* bitwise *)
fun BIT_OR_REDUCE(a, b) = "BIT_OR_REDUCE @" ^ locationToString(a, b)
fun BIT_AND_REDUCE(a, b) = "BIT_AND_REDUCE @" ^ locationToString(a, b)
fun BIT_XOR_REDUCE(a, b) = "BIT_XOR_REDUCE @" ^ locationToString(a, b)
fun BIT_DOUBLE_AND(a, b) = "BIT_DOUBLE_AND @" ^ locationToString(a, b)
fun BIT_DOUBLE_OR(a, b) = "BIT_DOUBLE_OR @" ^ locationToString(a, b)
fun BIT_DOUBLE_XOR(a, b) = "BIT_DOUBLE_XOR @" ^ locationToString(a, b)
...
fun BIT(value, a, b) = "BIT(" ^ GeminiBit.toString(value) ^ ") @" ^ locationToString(a, b)
fun STRING(value, a, b) = "STRING(" ^ value ^ ") @" ^ locationToString(a, b)
fun ID(id, a, b) = "ID(" ^ id ^ ") @" ^ locationToString(a, b)
fun TID(tid, a, b) = "TID(" ^ tid ^ ") @" ^ locationToString(a, b)
